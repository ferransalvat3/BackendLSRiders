...
public class Event implements Serializable {
    ...
    @OneToMany(mappedBy = "event")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<ParticipacionEvento> ratings = new HashSet<>();
    ...
    public Set<ParticipacionEvento> getRatings() {
        return ratings;
    }

    public Event ratings(Set<ParticipacionEvento> participacionEventos) {
        this.ratings = participacionEventos;
        return this;
    }

    public Event addRating(ParticipacionEvento participacionEvento) {
        this.ratings.add(participacionEvento);
        participacionEvento.setEvent(this);
        return this;
    }

    public Event removeRating(ParticipacionEvento participacionEvento) {
        this.ratings.remove(participacionEvento);
        participacionEvento.setEvent(null);
        return this;
    }

    public void setRatings(Set<ParticipacionEvento> participacionEventos) {
        this.ratings = participacionEventos;
    }
